...
export default function ParentDashboard() {
  ...
  if (totalRecords === 0 && offerings.length === 0) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center">
        <Eye className="w-12 h-12 text-muted-foreground mb-4" />
        <h2 className="text-xl font-bold">No linked students found</h2>
      ...
      <main className="max-w-6xl mx-auto p-6 space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Viewing as: {user?.first_name} {user?.last_name}
          </p>
        </div>
              ...
              {[
                {
                  color: "bg-primary",
                  label: "Present",
                  desc: "Student attended the required session duration.",
                },
                {
                ...
                },
                {
                  color: "bg-yellow-400",
                  label: "Late",
                  desc: "Excessive tardiness may have consequences.",
                },
                {
                  color: "bg-destructive",
                  label: "Absent",
                  desc: "Negatively impacts the student's attendance rate.",
                },
